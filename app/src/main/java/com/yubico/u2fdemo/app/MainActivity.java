...
public class MainActivity extends FragmentActivity implements OnLoginEnteredListener {
    ...
    private final LinkedHashMap<String, String> details = new LinkedHashMap<String, String>();
    ...
    public void onLoginEntered(String username, String password, boolean sign) {
        ...
        signFragment.setArguments(extras);

        EnrollFragment enrollFragment = new EnrollFragment();
        enrollFragment.setArguments(extras);

        Fragment fragment = sign ? signFragment
                : enrollFragment;
